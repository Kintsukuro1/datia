...
| [`backend/app/services/tabular_importer.py`](file:///c:/Users/Felipe/Desktop/Proyectos/democratizacion%20de%20datos/backend/app/services/tabular_importer.py) | **NUEVO** | Conversor estructurado e importador de archivos **CSV**, **Excel (.xlsx, .xls)** y volcados SQL a bases de datos SQLite con inferencia de tipos de columnas. |
...
| [`backend/tests/test_catalog_and_connectors.py`](file:///c:/Users/Felipe/Desktop/Proyectos/democratizacion%20de%20datos/backend/tests/test_catalog_and_connectors.py) | **NUEVO** | Suite de pruebas unitarias para ciclo de vida de catálogo, introspección de diccionario y subida/borrado de SQLite, CSV y Excel. |
